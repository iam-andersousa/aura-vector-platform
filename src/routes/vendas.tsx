    ...
    <>
            ...
            <table className="w-full min-w-[520px] text-sm">
              <thead>
                <tr className="border-b border-border text-left text-[11px] uppercase tracking-wider text-muted-foreground">
                  {["Vendedor", "Deals", "Win rate", "Receita", "Speed"].map((h) => (
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="grid gap-4">
          <AiCard
            tag="Priorização"
            title="4 leads com alta intenção hoje"
            body="Combinação de visita à página de preço + resposta rápida em WhatsApp."
          />
          <AiCard
            tag="Objeções"
            title="Preço lidera perdas no enterprise"
            body="Sugestão: apresentar ROI em 90 dias antes da faixa de investimento."
          />
        </div>
      </section>
    </>
