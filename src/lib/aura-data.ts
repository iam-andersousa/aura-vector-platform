export const kpis = [
  {
    ...
    area: "Vendas",
    trend: [312, 348, 402, 388, 452, 498, 540],
  },
  {
    label: "Leads ativos",
    value: "1.284",
    ...
    accent: "mkt" as const,
    area: "Marketing",
    trend: [820, 902, 968, 1024, 1102, 1188, 1284],
  },
  {
    ...
    delta: "+3,6%",
    up: true,
    hint: "R$ 9,1M em pipeline",
    accent: "sales" as const,
    area: "Vendas",
    trend: [168, 178, 192, 186, 201, 208, 216],
  },
  {
  ...
  },
  {
    ...
    delta: "+4,2%",
    up: true,
    hint: "reuniões agendadas",
    accent: "mkt" as const,
    area: "Marketing",
    trend: [58, 61, 63, 66, 68, 70, 72],
  },
];
...
export const nextActions = [
  {
    who: "Marina Souza",
    what: "Ligar para Helena Duarte — lead prioritário",
    when: "Hoje, 14:00",
    area: "Vendas",
  },
  {
    who: "Rafael Lima",
    what: "Enviar proposta revisada — Grupo Vertex",
    when: "Hoje, 16:30",
    area: "Vendas",
  },
  {
    who: "Camila Reis",
    what: "Reunião de resgate — Orbita Log",
    when: "Amanhã, 09:00",
    area: "Apoio ao Cliente",
  },
  ...
  {
    who: "Ana Prado",
    what: "Concluir onboarding — Clinix Saúde",
    when: "Sex, 11:00",
    area: "Apoio ao Cliente",
  },
];
...
export const stakeholders: Stakeholder[] = [
  {
    ...
    lastTouch: "há 2 dias",
    priority: "Alta",
    ai: "Enviar case do setor financeiro",
  },
  {
    id: "2",
    name: "Tiago Meireles",
    company: "Nova Lima Tech",
    type: "Cliente",
    status: "Em risco",
    origin: "Indicação",
    journey: "Retenção",
    ...
    lastTouch: "há 9 dias",
    priority: "Alta",
    ai: "Agendar QBR de resgate",
  },
  {
    id: "3",
    name: "Paula Andrade",
    company: "Clinix Saúde",
    type: "Usuário",
    status: "Onboarding",
    origin: "Google Ads",
    journey: "Onboarding",
  ...
  },
  {
    ...
    lastTouch: "há 5 dias",
    priority: "Alta",
    ai: "3 tickets em 7 dias — escalar",
  },
  {
    id: "5",
    name: "Sofia Mendes",
    company: "Belmar Retail",
    type: "Lead",
    status: "Qualificado",
    origin: "Meta Ads",
    journey: "Qualificação",
    owner: "Rafael Lima",
    health: 66,
    value: "R$ 140k",
    lastTouch: "há 1 dia",
    priority: "Média",
    ai: "Melhor canal: WhatsApp",
  },
  {
    id: "6",
    name: "Eduardo Rocha",
    company: "Prisma Consult",
    type: "Parceiro",
    status: "Ativo",
    origin: "Parceria",
    journey: "Expansão",
  ...
  },
  {
    ...
    lastTouch: "há 4 dias",
    priority: "Média",
    ai: "Oportunidade de upsell: +2 squads",
  },
];
...
export const timeline = [
  {
    ...
    channel: "WhatsApp",
    who: "Marina Souza",
    text: "Confirmou interesse no módulo de RevOps e pediu proposta com 2 cenários.",
  },
  {
    when: "Ontem, 16:40",
    channel: "Call",
    who: "Marina Souza",
    text: "Call de descoberta (38 min). Objeção: integração com Salesforce legado.",
  },
  {
    when: "3 dias atrás",
    channel: "E-mail",
    who: "Automação",
    text: "Sequência de nutrição — abriu 4 de 5 e-mails.",
  },
  {
    when: "6 dias atrás",
    channel: "LinkedIn Ads",
    who: "Marketing",
    text: "Converteu no formulário da campanha Front Office Intelligence.",
  },
];
  ...
  "Proposta enviada": [
    {
      ...
      id: "10",
      name: "Juliana Beck",
      company: "Nexa Energia",
      value: "R$ 420k",
      status: "Proposta enviada",
      ai: "Follow-up recomendado hoje",
    },
  ],
  "Cliente fechado": [
    {
...
export const campaigns = [
  {
    name: "Front Office Intelligence",
    channel: "LinkedIn Ads",
    leads: 312,
    quality: 82,
    cpl: "R$ 68",
...
export const integrations = [
  {
    ...
    items: [
      ["HubSpot", "Conectado"],
      ["Salesforce", "Requer configuração"],
  ...
  },
  {
    ...
    items: [
      ...
      ["Meta Ads", "Conectado"],
      ["LinkedIn Ads", "Conectado"],
      ["RD Station", "Disponível"],
    ],
  },
  {
    group: "Analytics",
  ...
  },
  {
    ...
    items: [
      ...
      ["Outlook Calendar", "Disponível"],
    ],
  },
  {
    group: "Financeiro / ERP",
    items: [
      ["Stripe", "Conectado"],
      ["SAP", "Em breve"],
      ["TOTVS", "Disponível"],
...
export const automations = [
  {
    name: "Novo lead → tarefa para SDR",
    when: "Quando um novo lead entra",
    then: "Cria tarefa para o SDR do rodízio",
    area: "Vendas",
    active: true,
    runs: 428,
  },
  {
    name: "Speed to Lead crítico",
    when: "Se o lead não for contatado em 5 minutos",
    then: "Alerta o gestor no Slack",
    area: "Vendas",
    active: true,
    runs: 96,
  },
  {
    name: "Risco de churn por tickets",
    when: "Se o cliente abrir 3 tickets em 7 dias",
    then: "Marca risco de churn e notifica CS",
    area: "Apoio ao Cliente",
    active: true,
    runs: 34,
  },
  {
    name: "Oportunidade parada",
    when: "Se a oportunidade ficar 7 dias sem interação",
    then: "Sugere follow-up com mensagem gerada por IA",
    area: "Vendas",
    active: true,
    runs: 212,
  },
  {
    name: "Health score alto → expansão",
    when: "Se o cliente tiver health score acima de 85",
    then: "Cria oportunidade de expansão",
    area: "Apoio ao Cliente",
    active: false,
    runs: 58,
  },
  {
    name: "Campanha com leads ruins",
    when: "Se a campanha gerar score médio abaixo de 50",
    then: "Alerta o time de marketing",
    area: "Marketing",
    active: true,
    runs: 17,
  },
...
export const aiCapabilities = [
  {
    title: "Resumo automático de interações",
    body: "Calls, e-mails e chats condensados em contexto acionável.",
  },
  { title: "Sugestão de próximo passo", body: "Recomendação por stakeholder, com justificativa." },
  {
    title: "Priorização de leads",
    body: "Score combinando intenção, fit e velocidade de resposta.",
  },
  ...
  { title: "Análise de sentimento", body: "Tom de cada interação por conta e por período." },
  {
    ...
    body: "Rascunhos contextualizados — revisão humana obrigatória.",
  },
